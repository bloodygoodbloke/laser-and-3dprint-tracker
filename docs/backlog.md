...
| ID | Type | Priority | Status | Title | Target Date | Details |
|---|---|---|---|---|---|---|
| CHG-XXX | Feature/Bug/Integration/Automation/Documentation/Feature Request | P1 Critical/P1 High/P2 Medium/P3 Low/Integrations | Planned/In Progress | Short title | YYYY-MM-DD or - | Clear summary of what will be done. |
